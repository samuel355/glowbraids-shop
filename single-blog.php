                ...
                <div class="row h-100 align-items-center">
                    <div class="col-5">
                        <div class="top-header-content">
                            <p>Welcome to Glowbraid's hair salon!</p>
                        </div>
                    </div>
                    <div class="col-7">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <div class="book-now-btn ml-5 mt-4 mt-lg-0 ml-md-4">
                                    <a href="#" class="btn akame-btn active">Book Now</a>
                                </div>
                            </div>
                            <!-- Nav End -->
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="post-content">
                        <div class="post-meta">
                            <a href="#" class="post-date"><i class="icon_clock_alt"></i> December 27, 2019</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-80">
                        <div class="post-thumbnail">
                            <a href="single-blog.php"><img src="img/bg-img/1.jpg" alt=""></a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-80">
                        <div class="post-thumbnail">
                            <a href="single-blog.php"><img src="img/bg-img/2.jpg" alt=""></a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-80">
                        <div class="post-thumbnail">
                            <a href="single-blog.php"><img src="img/bg-img/3.jpg" alt=""></a>
                        </div>
                        <div class="post-content">
