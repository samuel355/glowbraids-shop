<?php
session_start();
$db = mysqli_connect('localhost', 'root', '', 'glowbraids');
?>
                        ...
                        <div class="classynav">
                            ...
                            <div class="cart-icon ml-5 mt-4 mt-lg-0">
                                ...
                                if(!empty($_SESSION["shopping_cart"])) {
                                    ...
                                    ?>
                                    <div class="cart_div">
                                        <a class="btn btn-warning" href="./registration/login.php"> Cart <i class="fa fa-cart-plus text-white"></i><span class="text-white"> <?php echo $cart_count; ?></span></a>
                                    </div>
                                    <?php
                                }
                                ?>
        ...
        <div id="sell_section">
            <div class="row">
                ...
                while($row = mysqli_fetch_assoc($result)){
                    echo "<div class='col-sm-3 wow fadeInDownBig'>
                             <div class='card shadow ' style='width: 250px; height: 350px'>
                                    <form method='post' action=''>
                                        <div class='box'>
                                            ...
                                            <h5 class='text-center text-black-50 font-weight-bold'>".$row['name']."</h5>
                                            <div class='text-center text-danger font-weight-bold\'>GHs ".$row['price']."</div>
                                            <div class='text-center p-2'><button type='submit' class='btn btn-warning'>Add to Cart</button></div>
                                    </form>
                                </div><br>
                        </div>";
                }
